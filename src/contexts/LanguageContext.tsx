...
const translations: Record<Language, Record<string, string>> = {
  bg: {
    ...
    "partner.lora.desc": "Загадъчна и чаровна, тя знае как да те накара да се чувстваш специален. Перфектна за романтика! 🌹",
    "partner.ana.desc": "Страстна и уверена, обича да изследва новото и да споделя интимни моменти. Готова за приключения! 🔥",
